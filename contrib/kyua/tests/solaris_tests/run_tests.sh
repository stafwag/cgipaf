...
${solTestDir}/update_password_des/update_password_des.sh

exitCode=`expr $exitCode + $?`

${solTestDir}/update_password_sha256/update_password_sha256.sh

exitCode=`expr $exitCode + $?`

${solTestDir}/update_password_sha512/update_password_sha512.sh
